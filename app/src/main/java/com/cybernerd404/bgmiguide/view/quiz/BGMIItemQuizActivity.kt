...
import com.cybernerd404.bgmiguide.model.Ques
import com.cybernerd404.bgmiguide.utils.Constants
import kotlinx.android.synthetic.main.activity_bgmiitem_quiz.*

class BGMIItemQuizActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_bgmiitem_quiz)

        defaultOptionsView()

        mQuestionList = Constants.getOtherQues()
        setQuestion()
