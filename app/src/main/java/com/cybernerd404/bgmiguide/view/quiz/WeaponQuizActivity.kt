...
import kotlinx.android.synthetic.main.activity_weapon_quiz.*

class WeaponQuizActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_weapon_quiz)
